...
```{r}
ana > 30 | juan > 30 # Sí, se cumplen ambas condiciones
```
--
...
2. Instalar y cargar los paquetes `tidyverse`, `haven` y `readxl` a través del paquete `pacman`

--

3. Cargar set de datos `encuesta.xlsx` como `encuesta_excel` y cargar set de datos `encuesta.rds` como `encuesta_rds`
...
5. Aplicar operaciones básicas entre las columnas
